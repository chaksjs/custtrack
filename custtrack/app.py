...
DEFAULT_HANA = {
    'host': '77a696e3-0a74-42a7-b47a-577aa4476e59.hna1.prod-eu10.hanacloud.ondemand.com',
    'port': 443,
    'user': 'DBADMIN',
    'password': os.environ.get('HANA_PASSWORD', 'Chandra@1234'),
    'admin_email': 'dlfchander@gmail.com',
    'support_email': 'dlfchander@gmail.com',
    'sender_email': 'dlfchander@gmail.com',
    'sender_password': 'rsanlrclbdykbmvo',
...
def _get_smtp_creds():
    cfg = load_config()
    return cfg.get('sender_email', 'dlfchander@gmail.com'), cfg.get('sender_password', 'rsanlrclbdykbmvo')
...
def help_request():
    if 'user' not in session:
        return jsonify({'success': False}), 401
    cfg = load_config()
    support_email = cfg.get('support_email', cfg.get('sender_email', 'dlfchander@gmail.com'))
